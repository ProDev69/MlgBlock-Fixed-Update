...
class SWmain extends PluginBase {
    ...
    public function onEnable() : void
    {
        ...
        $this->configs = array_map(function($value){ return is_string($value) ? TextFormat::colorize($value) : $value; }, yaml_parse_file($this->getDataFolder() . "mb_configs.yml"));
        $this->lang = array_map([TextFormat::class, "colorize"], yaml_parse_file($this->getDataFolder() . "mb_lang.yml"));
    ...
    public function sendDeathMessage(Player $player) : void
    {
        ...
        switch ($last_cause_ev->getCause()) {
            ...
            case EntityDamageEvent::CAUSE_VOID:
                ...
                Server::getInstance()->dispatchCommand($player, "mb quit");
                                                          Server::getInstance()->dispatchCommand($player, "kill");
                break;
